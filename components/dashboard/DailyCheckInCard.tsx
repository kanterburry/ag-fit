...
import { ChevronRight, Activity, Flame, Moon, Smartphone, Zap, Check, Plus, Trash2 } from 'lucide-react'
    ...
    return (
        <>
            <Link href={`/dashboard/protocols/${protocol.id}`} className="block">
                <Card className="h-[280px] flex flex-col justify-between border border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900/80 transition-all duration-300 rounded-3xl overflow-hidden shadow-sm group w-full relative cursor-pointer">
