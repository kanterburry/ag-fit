        ...
        <div className="flex min-h-screen flex-col items-center justify-center p-4">
            <div className="flex flex-col items-center gap-6 rounded-2xl bg-surface p-8 shadow-xl ring-1 ring-slate-800">
                ...
                <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-5 py-3 text- font-semibold text-black transition-colors hover:bg-slate-200"
                >
